import SidenavItems from "./staffItems";
...
const style = {
    ...
    default: `h-[98vh]  text-white top-0 mx-4 my-2 rounded-2xl lg:relative bg-primary  lg:block `,
};
        ...
        >
            <div className={style.container}>
                <button
                    ...
                    onClick={toggle}
                    className="px-1 py-0 rounded-3xl bg-primary absolute bottom-0 -right-6 text-3xl text-white focus:outline-none text-center flex items-center justify-center"
                >
                    <svg className={
                        open
