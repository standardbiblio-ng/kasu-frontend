...
// import { COLUMNS } from "./CoursesTable/columns"
// import MOCKDATA from "./MOCK_DATA.json";

export function GenericTable(props) {
    const columns = useMemo(() => props.columns, []);
    const [tableLength, setTableLength] = useState(props.tableLength)
    const data = useMemo(
        () =>
    ...
    return (
        <div className="w-full  ">
            <div className={`flex flex-col bg-white w-[73.5vw] rounded-lg`}>
                <table
                    {...getTableProps()}
                ...
                {/* pagination */}
                <div className={`bg-white mx-auto grid grid-cols-4 w-[${props.tableLength}] items-center justify-between my-6 text-sm`}>
                    {/* 1 */}
                    <div className="w-full">
